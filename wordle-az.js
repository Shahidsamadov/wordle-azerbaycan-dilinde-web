          ...
          return o(t, [{
              ...
              value: function() {
                  if (this.gameStatus === Qa && this.canInput) {
                      if (5 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Kifayət qədər hərf yoxdur");
                      this.evaluateRow()
                  }
              }
          }, {
                  ...
                  this.shadowRoot.appendChild(rs.content.cloneNode(!0)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function(a) {
                      ...
                      s.classList.add("row"), a.forEach((function(e) {
                          ...
                          if (e >= "a" && e <= "z" || "←" === e || "↵" === e) {
                              ...
                              "↵" == e && (a.textContent = "TAMAM", a.classList.add("one-and-a-half"))
